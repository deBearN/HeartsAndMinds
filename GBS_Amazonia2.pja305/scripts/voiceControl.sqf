...
cutText[format["Chat/VON em %1 não é permitido!\nMude para %2 ou %3", str localize(VoN_channelId select 0), actionKeysNames ["nextChannel",1], actionKeysNames ["prevChannel",1]], "PLAIN DOWN", 1];
setCurrentChannel 5;
};
};
