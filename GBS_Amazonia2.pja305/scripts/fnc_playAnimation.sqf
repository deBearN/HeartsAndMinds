/*
	EXAMPLE :
	[player, "Acts_carFixingWheel", "playMove", {dayTime > 12}] spawn DBS_fnc_playAnimation;
	[unitA, "AmovPercMstpSnonWnonDnon_exercisePushup", "playMove", {true}] spawn DBS_fnc_playAnimation;
	[unitA, "AmovPercMstpSnonWnonDnon_exercisePushup", "playMove", {true}] remoteExec ["DBS_fnc_playAnimation", 0, unitA];
*/
